...
class HoroscopeController extends Controller
{
    ...
    public function interpretation($horoscope_name)
    {
        ...
        $dailyInterpretation = HtmlDomParser::file_get_html('https://www.hurriyet.com.tr/mahmure/astroloji/' . $horoscope_name . '-burcu/')->find('div[class="horoscope-detail-tab-content"]', 0)->find('p', 1);
        $weeklyInterpretation = HtmlDomParser::file_get_html('https://www.hurriyet.com.tr/mahmure/astroloji/' . $horoscope_name . '-burcu-haftalik-yorum/')->find('div[class="horoscope-detail-tab-content"]', 0)->find('p', 1);
        $monthlyInterpretation = HtmlDomParser::file_get_html('https://www.hurriyet.com.tr/mahmure/astroloji/' . $horoscope_name . '-burcu-aylik-yorum/')->find('div[class="horoscope-detail-tab-content"]', 0)->find('p', 1);
        $yearlyInterpretation = HtmlDomParser::file_get_html('https://www.hurriyet.com.tr/mahmure/astroloji/' . $horoscope_name . '-burcu-yillik-yorum/')->find('div[class="horoscope-detail-tab-content"]', 0)->find('p', 1);
